...
export default function Hero() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    window.open(`https://wa.me/201012673037?text=${encodeURIComponent(message)}`, "_blank", "noopener,noreferrer")
  }
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <button
                onClick={() => window.open("https://wa.me/201012673037", "_blank", "noopener,noreferrer")}
